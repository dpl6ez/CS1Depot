...
removedup: (eq a) => list a -> list a -> list a
removedup nil l2 = nil
removedup (h::t) l2 = (ite (member h l2) (removedup t l2) (h::(removedup t l2)))

set_union (mkSet l1) (mkSet l2) = (mkSet (append l1 (removedup l2 l1)))
...
-- Return the set difference, s1 minus s2
--set_difference: (eq a) => (s1: set a) -> (s2: set a) -> set a
set_difference (mkSet l1) (mkSet l2) = (mkSet (removedup l1 l2))
...
Return: list a -> option a
Return nil = none
Return (h::t) = some h

set_witness p (mkSet l) = Return (filter p l)
...
Pairmaker: list a -> list b -> list (pair a b)
Pairmaker l1 nil = nil
Pairmaker (h1::t1) (h2::t2) = (mkPair h1 h2)::((Pairmaker (h1::t1) (t2)))

Pairlist: list a -> list b -> list (pair a b)
Pairlist nil l1 = nil
Pairlist (h1::t1) (h2::t2) = (append (Pairmaker (h1::t1) (h2::t2)) (Pairlist t1 (h2::t2)))
